...
//validate_Whether_User_Should_Not_Be_Able_To_Add_Nine_Passengers_As_Childs
 ...
 *
 */
public class TC_Flights_15Test extends BaseClass{

	@Test(dataProvider="goibiboData", groups="smoke")
	public void validate_Whether_User_Should_Not_Be_Able_To_Add_Nine_Passengers_As_Childs (String[] arr) {
		//Precondition
		...
		//==============================================================================================================================================
		//Step6: Validate 9 Childs should not be add as a Passenger

		homepage.getTravellers().click();
		for(int i=1;i<=8; i++) {
			homepage.getChildPlusIcon().click();	
		}
		int childCountValue=8;
		int actualChildCountValue = Integer.parseInt(homepage.getChildPaxBox().getAttribute("value"));
		assertEquals(childCountValue, actualChildCountValue ,"9 Childs should be added as a Passenger");
